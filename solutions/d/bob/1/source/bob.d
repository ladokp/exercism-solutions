...
{
    if (isSilence(text)) return "Fine. Be that way!";
    else if (isShouting(text) && isQuestion(text)) return "Calm down, I know what I'm doing!";
    else if (isShouting(text)) return "Whoa, chill out!";
    else if (isQuestion(text)) return "Sure.";
    return "Whatever.";
}