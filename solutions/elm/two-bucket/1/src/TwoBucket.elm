...
type alias State = { moves : Int, bucketOne : Int, bucketTwo : Int }
type alias Params = { goal : Int, bucketOneSize : Int, bucketTwoSize : Int }
type alias History = Set ( Int, Int )


measure : Int -> Int -> Int -> BucketNumber -> Maybe State
measure bucketOneSize bucketTwoSize goal startBucket =
    let
        params = Params goal bucketOneSize bucketTwoSize
    ...
    in step params forbiddenState [ initialState ]
